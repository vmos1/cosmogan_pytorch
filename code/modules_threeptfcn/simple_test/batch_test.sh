...
srun -n 64 python $code_dir/3pt_fcn_simple.py -n 8 --img_slice 64 -idx $I -f /global/cfs/cdirs/m3363/vayyar/cosmogan_data/raw_data/3d_data/dataset1_smoothing_const_params_64cube_100k/val.npy -sfx 3d_dset1
